   ...
   */
    ...
    */
    ...
    'providers' => [
         ...
         */
        NDATV\Providers\AppServiceProvider::class,
        NDATV\Providers\AuthServiceProvider::class,
        NDATV\Providers\EventServiceProvider::class,
        Laravel\Tinker\TinkerServiceProvider::class,

        Modules\Core\Providers\AsgardServiceProvider::class,

        NDATV\Providers\RouteServiceProvider::class,
    ],
